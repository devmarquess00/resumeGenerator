...
export const ComponentAdds = () => {
  const { steps, handlePrev, stepState } = useContext(ContextStep);

  return (
    <>
      <div className="max-w-xl w-full mx-auto mt-30 mb-5 shadow-md rounded-sm">
      ...
      <div className="max-w-xl w-full mx-auto mb-20">
